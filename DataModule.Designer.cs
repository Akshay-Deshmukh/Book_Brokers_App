namespace BookBrokersApp
{
    partial class DataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ctnBookBroker = new System.Data.OleDb.OleDbConnection();
            ...
            this.dsBookBroker1 = new BookBrokersApp.DSBookBroker();
            ((System.ComponentModel.ISupportInitialize)(this.dsBookBroker1)).BeginInit();
            this.SuspendLayout();
            // 
            // oleDbSelectCommand1
            // 
    ...
    "horID";
            this.oleDbSelectCommand1.Connection = this.ctnBookBroker;
            // 
            // ctnBookBroker
            // 
            this.ctnBookBroker.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\temp\\BookBrokers.accdb";
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `AUTHOR` (`LastName`, `FirstName`) VALUES (?, ?)";
            this.oleDbInsertCommand1.Connection = this.ctnBookBroker;
    ...
    "IS NULL) OR (`FirstName` = ?)))";
            this.oleDbUpdateCommand1.Connection = this.ctnBookBroker;
    ...
    "";
            this.oleDbDeleteCommand1.Connection = this.ctnBookBroker;
    ...
    "ClientOrderID`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this.oleDbUpdateCommand2.Connection = this.ctnBookBroker;
            ...
            this.oleDbDeleteCommand2.Connection = this.ctnBookBroker;
    ...
    " BY BookInfoID";
            this.oleDbSelectCommand3.Connection = this.ctnBookBroker;
            // 
            // oleDbInsertCommand3
            // 
            this.oleDbInsertCommand3.CommandText = "INSERT INTO `BOOKINFO` (`Title`, `AuthorID`, `Notes`) VALUES (?, ?, ?)";
            this.oleDbInsertCommand3.Connection = this.ctnBookBroker;
            ...
            this.oleDbUpdateCommand3.Connection = this.ctnBookBroker;
            ...
            this.oleDbDeleteCommand3.Connection = this.ctnBookBroker;
    ...
    "ID, Email, CreditStatus\r\nFROM            CLIENT\r\nORDER BY ClientID";
            this.oleDbSelectCommand4.Connection = this.ctnBookBroker;
            // 
            // oleDbInsertCommand4
            // 
    ...
    " `CountryID`, `Email`, `CreditStatus`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            this.oleDbInsertCommand4.Connection = this.ctnBookBroker;
            ...
            this.oleDbUpdateCommand4.Connection = this.ctnBookBroker;
            ...
            this.oleDbDeleteCommand4.Connection = this.ctnBookBroker;
    ...
    "RDER\r\nORDER BY ClientOrderID";
            this.oleDbSelectCommand5.Connection = this.ctnBookBroker;
            // 
            // oleDbInsertCommand5
            // 
            this.oleDbInsertCommand5.CommandText = "INSERT INTO `CLIENTORDER` (`OrderDate`, `ClientID`, `Status`) VALUES (?, ?, ?)";
            this.oleDbInsertCommand5.Connection = this.ctnBookBroker;
            ...
            this.oleDbUpdateCommand5.Connection = this.ctnBookBroker;
            ...
            this.oleDbDeleteCommand5.Connection = this.ctnBookBroker;
    ...
    "";
            this.oleDbSelectCommand6.Connection = this.ctnBookBroker;
            // 
            // oleDbInsertCommand6
            // 
            this.oleDbInsertCommand6.CommandText = "INSERT INTO `COUNTRY` (`CountryName`) VALUES (?)";
            this.oleDbInsertCommand6.Connection = this.ctnBookBroker;
    ...
    "CountryName` IS NULL) OR (`CountryName` = ?)))";
            this.oleDbUpdateCommand6.Connection = this.ctnBookBroker;
    ...
    "ULL) OR (`CountryName` = ?)))";
            this.oleDbDeleteCommand6.Connection = this.ctnBookBroker;
    ...
    "    VENDOR\r\nORDER BY VendorID";
            this.oleDbSelectCommand7.Connection = this.ctnBookBroker;
            // 
            // oleDbInsertCommand7
            // 
            this.oleDbInsertCommand7.CommandText = "INSERT INTO `VENDOR` (`VendorName`, `PostBoxNumber`, `CountryID`, `Email`) VALUES" +
    " (?, ?, ?, ?)";
            this.oleDbInsertCommand7.Connection = this.ctnBookBroker;
            ...
            this.oleDbUpdateCommand7.Connection = this.ctnBookBroker;
            ...
            this.oleDbDeleteCommand7.Connection = this.ctnBookBroker;
            ...
            // dsBookBroker1
            // 
            this.dsBookBroker1.DataSetName = "DSBookBroker";
            this.dsBookBroker1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // DataModule
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dsBookBroker1)).EndInit();
        ...
        private System.Data.OleDb.OleDbConnection ctnBookBroker;
        ...
        public DSBookBroker dsBookBroker1;
    }
}